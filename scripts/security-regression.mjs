...
mustContain('supabase/migrations/040_safe_swap_and_campus_growth.sql', 'QR release is only allowed inside an approved 50m Safe Swap Zone');
...
mustContain('src/pages/SafeSwapZone.tsx', 'VERIFY SAFE SWAP LOCATION');
mustContain('src/pages/SafeSwapZone.tsx', 'openstreetmap.org/export/embed.html');
