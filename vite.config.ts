...
export default defineConfig(({ mode }) => ({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'Campus Plug', short_name: 'Campus Plug',
        description: 'Tactical-aesthetic student marketplace',
        theme_color: '#0a0a0a', background_color: '#0a0a0a', display: 'standalone',
        icons: [
